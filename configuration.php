...
class JConfig
{
	...
	public $sitename = 'jm';            // Name of Joomla site
	...
	public $host = 'localhost:30006';              // This is normally set to localhost
	...
	/* Server Settings */
	public $secret = 'arDCvCpXD8HSfG22';     // Change this to something more secure
	public $gzip = '0';
	...
	public $ftp_root = '';
	public $ftp_enable = '0';
	public $tmp_path = 'C:\Users\PC\Documents\stackabl-v26\jm\code/tmp/';                // This path needs to be writable by Joomla!
	public $log_path = 'C:\Users\PC\Documents\stackabl-v26\jm\code/logs/'; // This path needs to be writable by Joomla!
